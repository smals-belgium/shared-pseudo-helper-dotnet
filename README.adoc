= ICT ReUse Pseudonymisation Helper
:version: 0.1
:lang: en
:icons: font
:toc:
...
== Build the Pseudonymisation Helper library

.NET 8.0
dotnet build ./src/Nihdi.Common.Pseudonymisation/Nihdi.Common.Pseudonymisation.csproj

.NET 4.8
msbuild /t:Build /p:Configuration=Release ./src/Nihdi.Common.Pseudonymisation/Nihdi.Common.Pseudonymisation.csproj
...
| A function supplying the private keys that are defined in the JWKS supplied by jwksSupplier.
...
[source,cs]
----
include::src/Be.Ict.Reuse.Pseudonymisation.CodeSamples/PseudonymisationHelper_Initialization.cs[tag=snippet1]
----

[source,cs]
----
include::src/Be.Ict.Reuse.Pseudonymisation.CodeSamples/PseudonymisationHelper_Initialization.cs[tag=snippet2]
----
...
.Exemple with Be.Ict.Reusehealth_v1` domain
====
[source,cs]
----
...
.Exemple that Be.Ict.Reuse `uhmep_v1` domain
====
[source,cs]
----
...
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/PseudonymiseASsin.cs[tag=PseudonymizeSsinSynchronous]
----
Be.Ict.Reuse
.Asynchronous code
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/PseudonymiseASsin.cs[tag=PseudonymizeSsinAsynchronous]
----
...
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/IdentifyASsin.cs[tag=sync]
----
...
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/IdentifyASsin.cs[tag=async]
----

=== Identify mBe.Ict.Reuses returned by a REST API
.Asynchronous code
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/IdentifyMultipleSsins.cs[tag=async]
----
...
[source,cs,indent=2]
----
include::src//Nihdi.Common.Pseudonymisation.CodeSamples/ResolvePseudoAtRestFromPseudoInTransit.cs[tag=async]
----
